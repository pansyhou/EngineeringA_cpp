...
//ext_rfid_status_t robot_rfid_status;
//
////TODO:加入RFID
//
//
...
//    memset(&robot_rfid_status, 0, sizeof(ext_rfid_status_t));
//
//    //裁判系统结构体初始化
//    Referee_t referee={
//        .powerHeatData=&power_heat_data_t,
//        .extEventData=&field_event,
//        .rfidStatus=&robot_rfid_status,
//        .robotPos=&game_robot_pos_t,
//        .robotHp=&game_robot_HP_t
//    };
//
//}
//
...
//        case RFID_CMD_ID:
//        {//TODO:待测试
//          memcpy(&robot_rfid_status, frame + index, sizeof(ext_rfid_status_t));
//        } break;
//
